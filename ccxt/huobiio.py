...
class huobiio(Exchange):

    def describe(self):
        return self.deep_extend(super(huobiio, self).describe(), {
            'id': 'huobiio',
            'name': 'Huobi Pro',
            'countries': ['CN'],
            'rateLimit': 2000,
            ...
            'accounts': None,
            'accountsById': None,
            'hostname': 'api.huobi.io',  # api.testnet.huobi.pro
            'pro': True,
            'has': {
            ...
            'urls': {
                'test': {
                    'market': 'https://api.testnet.huobi.io',
                    'public': 'https://api.testnet.huobi.io',
                    'private': 'https://api.testnet.huobi.io',
                },
